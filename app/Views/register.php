    ...
    <div class="relative h-screen bg-white">
        <div class="grid grid-cols-2">
            <div class="h-full flex flex-col items-center justify-center">
                ...
                <form class="" method="POST" accept-charset="utf-8" action="<?php echo base_url() . 'register-data'; ?>">
                    <?php csrf_field() ?>
                    <h1 class="text-black font-bold text-2xl text-center mb-4">Daftar Akun Jakita</h1>
                    <div class="mb-4">
                    ...
                    <div class="flex">
                        <button class="grow bg-black text-white p-2">Register</button>
                    </div>
                </form>
            </div>
